...
Ball rb = new Ball( 10 , new Color(255,0,0));
Ball gb = new Ball( 10 , new Color( 0,255,0));
Ball bb = new Ball(10,new Color(0,0,255));
Console.WriteLine(rb.ThrowCount());
gb.ThrowCount();
Console.WriteLine(gb.ThrowCount());
bb.ThrowCount();
bb.Pop();
Console.WriteLine(bb.ThrowCount());
Color grey = new Color(100, 245, 2);
Console.WriteLine(grey.GreyScaleV());
